...
public class MainActivity extends AppCompatActivity {
    ...
    private void createChannel(String channelId, String channelName, int level) {
        ...
        channel.setSound(Uri.parse("android.resource://" + "com.demo.notificationdemo" + File.separator + R.raw.ring_6), audioAttributes);
    ...
    private void sendPopUpMsg(View view, int num) {
        ...
        Notification notification = new NotificationCompat.Builder(this, "popUpMsg")
                ...
                .setAutoCancel(true)
                .setSound(Uri.parse("android.resource://" + "com.demo.notificationdemo" + File.separator + R.raw.ring_6))
                .setNumber(num)
                .build();
