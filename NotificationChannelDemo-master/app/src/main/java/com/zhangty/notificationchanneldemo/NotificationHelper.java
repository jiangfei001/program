...
class NotificationHelper extends ContextWrapper {
    ...
    public NotificationChannel crateNotification(String channelId, String name) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            Uri uri = Uri.parse("android.resource://"+this.getPackageName()+"/" + R.raw.ring_6);
    ...
    public Notification.Builder getNotification(String title, String body, String channelId) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            return new Notification.Builder(getApplicationContext(), channelId)
                    ...
                    .setSound(Uri.parse("android.resource://" + "com.zhangty.notificationchanneldemo" + File.separator + R.raw.ring_6))
                    .setAutoCancel(true);
        } else {
            return null;
        }
