    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tv_send_notify1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                notificationHelper.sendNotifycation("第一条通知的标题", "第一条通知的内容", NotificationHelper.SECONDARY_CHANNEL, NOTI_PRIMARY1);
            }
        });
        ...
        findViewById(R.id.tv_send_notify2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                notificationHelper.sendNotifycation("第二条通知的标题", "第二条通知的内容", NotificationHelper.SECONDARY_CHANNEL, NOTI_PRIMARY2);
            }
        });
