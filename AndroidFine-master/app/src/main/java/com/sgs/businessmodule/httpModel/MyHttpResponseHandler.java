...
public class MyHttpResponseHandler {
        ...
        if (Looper.myLooper() != null) {
            handler = new Handler() {
                ...
                public void handleMessage(Message msg) {
                    MyHttpResponseHandler.this.handleMessage(msg);
                }
            };
        }
    }
    ...
    protected void sendSuccessMessage(MyApiResponse response) {
        try {
    ...
    protected void handleSuccessMessage(MyApiResponse response) {
        onSuccess(response);
    }
    ...
    protected void handleMessage(Message msg) {
        switch (msg.what) {
            case SUCCESS_MESSAGE:
                handleSuccessMessage((MyApiResponse) msg.obj);
                break;
