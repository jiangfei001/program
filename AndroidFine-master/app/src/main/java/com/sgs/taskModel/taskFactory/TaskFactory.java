package com.sgs.taskModel.taskFactory;

import com.sgs.commandModel.InstructionTypeEnum;
import com.sgs.dbModel.entity.InstructionRequest;
import com.sgs.taskModel.ITask;
import com.sgs.taskModel.TVTask;
import com.sgs.taskModel.taskList.CLOSE;
...
public class TaskFactory {
  ...
  /*  CLOSE(100, "close", "关闭"),
    ...
    public static TVTask createTask(InstructionRequest instructionRequest) {
        ...
        try {
            Class operationObj1 = Class.forName("com.sgs.taskModel.taskList." + instructionTypeEnum.getType().toUpperCase());
            try {
